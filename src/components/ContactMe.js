          ...
          <form ref={form} onSubmit={handleSubmit}>
            <Grid container>
              ...
              <Grid item xs={12} sx={{ textAlign: "center", marginTop: 5 }}>
                ...
                <Link
                  href="https://www.linkedin.com/in/seth-ofori-amanfo-86229a75?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B2LxjcteaQiOuIgqY65MYew%3D%3D/"
                  color="inherit"
                  underline="none"
                  target="_blank"
                  rel="noopener">
                ...
                <Link
                  href="mailto:sofori5150@gmail.com"
                  color="inherit"
                  underline="none"
                  target="_blank"
                  rel="noopener">
                ...
                <Link
                  href="https://twitter.com/amigo20_"
                  color="inherit"
                  underline="none"
                  target="_blank"
                  rel="noopener">
